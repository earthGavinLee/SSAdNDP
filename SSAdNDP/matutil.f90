...
CONTAINS
  ...
  FUNCTION matsqrt_real(dmat)
    ...
    CALL GEMM(vecs,matsqrt_real,dummy,'N','N',1.d0,0.d0)
    CALL GEMM(dummy,vecs,matsqrt_real,'N','T',1.d0,0.d0)
  ...
  FUNCTION matsqrt_complex(cmat)
    ...
    CALL GEMM(vecs,matsqrt_complex,dummy,'N','N',(1.d0,0.d0),(0.d0,0.d0))
    CALL GEMM(dummy,vecs,matsqrt_complex,'N','C',(1.d0,0.d0),(0.d0,0.d0))
  ...
  FUNCTION matinvsqrt_real(dmat)
    ...
    CALL GEMM(vecs,matinvsqrt_real,dummy,'N','N',1.d0,0.d0)
    CALL GEMM(dummy,vecs,matinvsqrt_real,'N','T',1.d0,0.d0)
  ...
  FUNCTION matinvsqrt_complex(cmat)
    ...
    CALL GEMM(vecs,matinvsqrt_complex,dummy,'N','N',(1.d0,0.d0),(0.d0,0.d0))
    CALL GEMM(dummy,vecs,matinvsqrt_complex,'N','C',(1.d0,0.d0),(0.d0,0.d0))
  ...
  FUNCTION matexp(dmat)
    ...
    CALL GEMM(vecs,matexp,dummy,'N','N',1.d0,0.d0)
    CALL GEMM(dummy,vecs,matexp,'N','T',1.d0,0.d0)
  ...
  SUBROUTINE diag_general(dmat,smat,dvals,dvecs)
    ...
    CALL GEMM(shalfi,dmat,dummy,'T','N',1.d0,0.d0)
    CALL GEMM(dummy,shalfi,dmat,'N','N',1.d0,0.d0)
    ...
    dummy = dvecs
    CALL GEMM(shalfi,dummy,dvecs,'N','N',1.d0,0.d0)
  ...
  FUNCTION matinv_real(dmat)
    ...
    matinv_real=dmat
    CALL GETRF(matinv_real,ipiv,info)
    CALL GETRI(matinv_real,ipiv,info)
  ...
  FUNCTION matinv_complex(cmat)
    ...
    matinv_complex=cmat
    CALL GETRF(matinv_complex,ipiv,info)
    CALL GETRI(matinv_complex,ipiv,info)
...
!Fortran 90 wrappers for diag routines
  ...
  SUBROUTINE matdiag_complex(cmat,evals,evecs)
    ...
    CALL heev(evecs,evals,'V','U',info)
  ...
  FUNCTION matunitary_trans_real(A,U) RESULT(Ap)
    ...
    CALL GEMM(A,U,dummy,'N','T',1.d0,0.d0)
    CALL GEMM(U,dummy,Ap,'N','N',1.d0,0.d0)
  ...
  FUNCTION matunitary_trans_complex(A,U) RESULT(Ap)
    ...
    CALL GEMM(A,U,dummy,'N','C',(1.d0,0.d0),(0.d0,0.d0))
    CALL GEMM(U,dummy,Ap,'N','N',(1.d0,0.d0),(0.d0,0.d0))
  ...
  FUNCTION matunitary_trans_complex2(A,U) RESULT(Ap)
    ...
    U_comp = U
    !Ap=MATMUL(U,MATMUL(A,TRANSPOSE(U)))
    CALL GEMM(A,U_comp,dummy,'N','C',(1.d0,0.d0),(0.d0,0.d0))
    CALL GEMM(U_comp,dummy,Ap,'N','N',(1.d0,0.d0),(0.d0,0.d0))
