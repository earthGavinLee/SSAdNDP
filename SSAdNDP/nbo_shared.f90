MODULE nbo_shared
  ...
  SUBROUTINE calc_nelec(inp,is_orthog)
    ...
    DO ispin=1,inp%nspins
       DO ik=1,nk
          CALL GEMM(inp%rhok(:,:,ik,ispin),inp%sk(:,:,ik),nelec_dummy,'N','C',(1.d0,0.d0),(0.d0,0.d0))
          nelec=nelec+inp%kpt_wt(ik)*mattrace(nelec_dummy) 
          CALL GEMM(inp%rhok(:,:,ik,ispin),inp%fockk(:,:,ik,ispin),nelec_dummy,'N','C',(1.d0,0.d0),(0.d0,0.d0))
